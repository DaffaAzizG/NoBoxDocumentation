...
Promotion is one of the menus on Nobox.Ai to carry out promotions easily and efficiently to target promotions by interacting with various channels such as WhatsApp, Telegram, etc

<figure><img src="../../.gitbook/assets/Campaigns.png" alt=""><figcaption></figcaption></figure>

On the display, there are several promotion statuses. The explanation of the status is as follows:

<table data-header-hidden><thead><tr><th width="105.800048828125"></th><th></th></tr></thead><tbody><tr><td><img src="../../.gitbook/assets/draft.png" alt=""></td><td> Promotion data draft status is still not processed</td></tr><tr><td><img src="../../.gitbook/assets/process (1).png" alt=""></td><td> Promotion data process status is still in the delivery process</td></tr><tr><td><img src="../../.gitbook/assets/done.png" alt=""></td><td>Promotion data completion status has been marked as complete</td></tr><tr><td><img src="../../.gitbook/assets/cancel.png" alt=""></td><td>Promotion data canceled status cancelled</td></tr></tbody></table>

Add Promotion

To add promotional data, please click the \[Promotion]➔\[Add Promotion] menu and the \[Add Promotion] dialog will appear.
